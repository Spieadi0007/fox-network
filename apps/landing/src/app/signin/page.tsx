  ...
  return (
    <div className="relative z-10 w-full max-w-md">
      ...
      <div className="rounded-2xl border border-stone-200/80 bg-white/80 p-8 shadow-xl shadow-stone-200/40 backdrop-blur-xl">
        ...
        <div className="mt-6 space-y-3">
          ...
          <button
            type="button"
            disabled
            className="flex w-full items-center justify-center gap-3 rounded-full border border-stone-200/80 bg-white px-5 py-3 text-sm font-medium text-stone-400 shadow-sm shadow-stone-200/20 opacity-60"
          >
      ...
      <p className="mt-6 text-center text-sm text-stone-500">
        ...
        <Link
          href="/signup"
          className="font-medium text-fox-orange hover:text-fox-orange/80 transition-colors"
        >
          Sign up
        </Link>
      </p>
